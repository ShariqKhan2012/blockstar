...
const ContestCard = ({ title, addr, thumbnailUrl }) => {
    return (
        <div className="rounded-lg p-6 bg-[#fafafa] border-[1px] border-[#ddd] shadow-sm">
            ...
            <div className="px-4 py-4 flex flex-col content-center">
                ...
                <NavLink to={`/contests/${addr}`} className="bg-[#9106cd] hover:bg-[#850cb9] py-2 px-4 inline-block mx-auto mt-4  rounded-lg text-white text-center text-sm">View Details</NavLink>
            </div>
        </div>
    )
}
